...
public final class ModBlockEntities {
    ...
    // that order) so that ModBlocks.WHEAT_FARM already exists here. The lambda referencing
    // WHEAT_FARM below is fine even though WHEAT_FARM isn't assigned yet at this line, because
    // the lambda body only executes later, when a block entity is actually created.
    public static final BlockEntityType<FarmBlockEntity> WHEAT_FARM = register("wheat_farm",
